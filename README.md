...
CA-Private-Colleges/ 
├── PRA Response/ ← Original PRA production documents 
├── code/ ← Extraction, cleaning, and analysis scripts 
├── data/ │ 
   ├── raw/ ← Raw data extracted from PRA documents 
   │ └── cleaned/ ← Cleaned data used to generate figures 
